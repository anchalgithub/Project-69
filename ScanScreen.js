...
<Image source={require("./assets/scan.jpg")} style={{width:200, height: 200}}/>

<Text style = {{fontSize:45, color: 'black', fontWeight:'bold', fontFamily: 'times new roman' }}>Bar Code Scanner</Text>
